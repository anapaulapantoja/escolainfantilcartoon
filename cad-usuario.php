...
<form action="?page=salvar-usuario" method="POST" enctype="multipart/form-data">
	<div class="form-group">
		...
		<input type="text" maxlength="80" name="nome" class="form-control" required >
	</div>
	<div class="form-group">
		<label>Email</label>
	...
	<div class="form-group">
		...
		<input type="text" maxlength="45" name="usuario" class="form-control" required >
	</div>
	<div class="form-group">
		<label>Senha</label>
		<input type="password" maxlength="20" name="senha" class="form-control" required >
	</div>
	<div class="form-group">
